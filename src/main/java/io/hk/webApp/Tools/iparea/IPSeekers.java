package io.hk.webApp.Tools.iparea;
 ...
 *
 */
public class IPSeekers {

	private static final Logger log = LoggerFactory.getLogger(IPSeekers.class);
	...
	// 单一模式实例
	private static IPSeekers instance = new IPSeekers();
	// 起始地区的开始和结束的绝对偏移
	...
	private IPSeekers() {
		...
		try {
			...
			InputStream inputStream = IPSeekers.class.getClassLoader().getResourceAsStream("qqwry.dat");
...
//				System.out.println("IP地址信息文件格式有错误，IP显示功能将无法使用");
	 ...
	 * @return 单一实例
	 */
	public static IPSeekers getInstance() {
		return instance;
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(IPSeekers.getInstance().getAddress("120.36.255.7"));
